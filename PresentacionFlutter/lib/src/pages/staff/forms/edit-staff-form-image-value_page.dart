...
class EditStaffFormImageValuePage extends StatefulWidget {
  @override
  _EditStaffFormImageValuePageState createState() =>
      _EditStaffFormImageValuePageState();
}

class _EditStaffFormImageValuePageState
    extends State<EditStaffFormImageValuePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('Edit Staff Form Image'),
          actions: <Widget>[
            IconButton(
  ...
  _save() {
    if (image != null) {
      ...
      staffFormImageValue.id = -1;
      staffFormImageValue.idfStaff = staff.id;
      staffFormImageValue.idfStaffForm = staffFormByStaff.id;
      staffFormImageValue.image = stringImage;
      staffFormImageValue.formDateTime = selectedDate;
      staffFormImageValue.dateTime = selectedDate;
      staffFormProvider
          .saveStaffFormImageValue(staffFormImageValue)
          .then((result) {
        if (result) {
          {
            image = null;
